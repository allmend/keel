...
| `keel_auth_failures_total` | counter | `vhost`, `reason` | Requests answered 401 by an `auth` rule. Reasons: `missing`, `malformed`, `algorithm`, `signature`, `expired`, `not_yet_valid`, `issuer`, `audience` |
